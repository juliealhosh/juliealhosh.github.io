...
export default function NotFound() {
  return (
    <>
      <main className="mx-auto text-text w-full max-w-7xl px-6 pb-16 sm:pb-24 lg:px-8">
        <div className="mx-auto mt-20 max-w-2xl text-center sm:mt-24">
          <p className="text-base font-semibold leading-8 text-cyan">404</p>
          <h1 className="mt-4 text-3xl font-bold tracking-tight sm:text-5xl">
            This page does not exist
          </h1>
          <p className="mt-4 text-text leading-7 sm:mt-6 sm:text-lg sm:leading-8">
        ...
        <div className="mx-auto mt-6 flow-root max-w-lg sm:mt-20">
          ...
          <ul className="-mt-6 divide-y divide-overlay1 border-base">
            {links.map((link, linkIdx) => (
              <li key={linkIdx} className="relative flex gap-x-6 py-6">
                <div className="flex h-10 w-10 flex-none items-center justify-center rounded-lg shadow-sm ring-1 ring-gray-900/10">
                  <link.icon className="h-6 w-6 text-cyan" aria-hidden="true" />
                </div>
