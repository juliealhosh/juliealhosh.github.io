    ...
    <>
      <div className="px-6 py-32 lg:px-8">
        <div className="mx-auto max-w-3xl text-text leading-7">
          ...
          <h3 className="mt-3 text-xl font-bold text-indigo-50">Icons</h3>
          <h4 className="mt-3 text-lg font-bold text-indigo-50">Header</h4>
          <p className="mt-3 text-text leading-8">
            The animated sun and moon icons to switch site theme in the header were created by{' '}
            <a href="https://github.com/cyberalien/line-md" className="text-cyan hover:text-teal">
              Vjacheslav Trushkin
            </a>{' '}
            and are under an MIT license.
          </p>
          <h4 className="mt-3 text-lg font-bold text-indigo-50">Footer</h4>
          <p className="mt-3 text-text leading-8">
            All icons are by{' '}
            <a
              href="https://github.com/simple-icons/simple-icons"
              className="text-cyan hover:text-teal"
            >
              Simple Icon Collaborators
            </a>{' '}
            and are under a CC0 1.0 license. Except for the checkmark icon which is by{' '}
            <a href="https://phosphoricons.com/" className="text-cyan hover:text-teal">
              Phosphor Icons
            </a>{' '}
            and is licensed under the MIT license.
          </p>
          <h4 className="mt-3 text-lg font-bold text-indigo-50">Profile Picture/Icon</h4>
          <p className="mt-3 text-text leading-8">
            My profile picture is courtesy of{' '}
            <a href="https://www.andycarolan.com" className="text-cyan hover:text-teal">
              Andy Carolan
            </a>
            .
          </p>
          <h4 className="mt-3 text-lg font-bold text-indigo-50">Content</h4>
          <p className="mt-3 text-text leading-8">
