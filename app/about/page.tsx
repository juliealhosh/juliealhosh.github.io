    ...
    <>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          <h1 className="text-3xl font-extrabold leading-9 tracking-tight text-indigo-950 dark:text-white sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
            About
          </h1>
        </div>
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center pt-8">
            ...
            <h3 className="pt-4 pb-2 text-2xl text-indigo-950 dark:text-white font-bold leading-8 tracking-tight">
              {siteMetadata.author}
            </h3>
          ...
          <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
            <p className="mt-8">
              <p className="mt-8 mb-4 text-indigo-950 dark:text-white">
              ...
              <h2 className="mt-8 mb-4 text-2xl text-indigo-950 font-semibold dark:text-white">
                <a
                  className="!font-semibold !text-black !no-underline dark:!text-indigo-50"
                  href="/static/cv.pdf"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <h2 className="mt-8 mb-4 text-2xl font-semibold !text-black dark:!text-indigo-50">
                Skills
              </h2>
              <div className="mb-2 flex flex-wrap">
                <span
                  className="mr-2 mb-2 rounded-sm px-2 py-1 text-xs font-medium text-indigo-50"
