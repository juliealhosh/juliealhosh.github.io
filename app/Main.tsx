    ...
    <>
      <div className="fade-in banner flex flex-1 flex-row flex-wrap justify-between px-6 py-10 dark:text-white lg:px-10">
        <div className="flex flex-col justify-center">
          <h1 className="text-3xl text-indigo-950 font-bold dark:text-white lg:text-5xl">
            {siteMetadata.author}
          </h1>
          <p className="my-2 text-indigo-950 lg:my-4 lg:text-2xl dark:text-white">
            Member of the Mobile Robotics Lab <br /> of the Centre for Intelligent Machines <br />
            at McGill University
          </p>
          <p className="font-light text-indigo-950 lg:text-xl dark:text-white">
            Read more
          ...
          <div className="grid grid-cols-1 grid-rows-2 gap-8 py-12">
            <div className="my-2 grid items-start gap-8">
              <div className="group relative">
                ...
                <Link href="/projects">
                  <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-indigo-50 px-7 py-4 leading-none dark:bg-black">
