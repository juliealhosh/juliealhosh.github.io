            ...
            <div className='fade-in banner flex flex-1 flex-row flex-wrap justify-between px-6 py-10 dark:text-white lg:px-10'>
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <p className='my-2 text-lg lg:my-4 lg:text-2xl'>
                        Member of the Mobile Robotics Lab  <br/> of the Centre for Intelligent Machines  <br/>at McGill University
                    </p>
                    ...
                    <div className="grid grid-cols-1 grid-rows-2 gap-8 py-12">
                        ...
                        {/* <div className="grid gap-8 items-start my-2">
                            <div className="relative group">
                                <div
                                    className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-pink-600 rounded-lg blur opacity-50 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
                                <Link href="/blog">
                                    <a><span
                                        ...
                                        <span
                                            className="pr-6 text-gray-900 dark:text-gray-100">Read my notes</span></span><span
                                        className="pl-6 text-indigo-400 transition duration-200 group-hover:text-gray-900 dark:group-hover:text-gray-100">Recaps&nbsp;→</span></span></a>
                                </Link>
                            </div>
                        </div> */}
                            ...
                            <div className="group relative">
                                ...
                                <Link href="/projects">
                                    <a><span
                                        ...
                                        <span
                                            className="pr-6 text-gray-900 dark:text-gray-100">What I worked on</span></span><span
                                        className="pl-6 text-indigo-400 transition duration-200 group-hover:text-gray-900 dark:group-hover:text-gray-100">Projects&nbsp;→</span></span></a>
                                </Link>
                            </div>
                        </div>
                        <div className="my-2 grid items-start gap-8">
                            <div className="group relative">
                                <div
                                    className="animate-tilt absolute -inset-0.5 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 opacity-50 blur transition duration-1000 group-hover:opacity-100 group-hover:duration-200"></div>
                                <Link href="/about">
                                    <a><span
                                        className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black"><span
                                        className="flex items-center space-x-5">
                                        ...
                                        <span
                                            className="pr-6 text-gray-900 dark:text-gray-100">Resume and more info</span></span><span
